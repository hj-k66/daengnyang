...
class MonitoringRestControllerTest extends ControllerTest {
	...
	@Nested
	@DisplayName("모니터링 달 단위 조회")
	class MonitoringShowMonthly {
		...
		void success() throws Exception {
			...
			mockMvc.perform(
					...
					.andDo(restDocs.document(
							...
							responseFields(
									fieldWithPath("resultCode").description("결과코드"),
									fieldWithPath("result.monthlyMonitorings").description("모니터링 리스트"),

									fieldWithPath("result.monthlyMonitorings[].date").description("모니터링 날짜"),
									fieldWithPath("result.monthlyMonitorings[].weight").description("몸무게"),
									fieldWithPath("result.monthlyMonitorings[].vomit").description("구토"),
									fieldWithPath("result.monthlyMonitorings[].amPill").description("오전 투약"),
									fieldWithPath("result.monthlyMonitorings[].pmPill").description("오후 투약"),
									fieldWithPath("result.monthlyMonitorings[].customSymptom")
											.description("커스텀 모니터링"),
									fieldWithPath("result.monthlyMonitorings[].customSymptomName")
											.description("커스텀 모니터링 지표"),
									fieldWithPath("result.monthlyMonitorings[].feedToGram").description("식이량(g)"),
									fieldWithPath("result.monthlyMonitorings[].walkCnt").description("산책 횟수"),
									fieldWithPath("result.monthlyMonitorings[].playCnt").description("놀이 횟수"),
									fieldWithPath("result.monthlyMonitorings[].urination").description("배뇨 횟수"),
									fieldWithPath("result.monthlyMonitorings[].defecation").description("배변 횟수"),
									fieldWithPath("result.monthlyMonitorings[].respiratoryRate").description("호흡수"),
									fieldWithPath("result.monthlyMonitorings[].customInt").description("커스텀 모니터링"),
